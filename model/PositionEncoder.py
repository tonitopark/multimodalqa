...
class PositionalEncoder(torch.nn.Module):
    ...
    def __init__(self, vocab_size, emb_dim, max_len, batch_size, emb_mat):
        ...
        #     emb_mat     : torch tensor containing the embedding matrix
        #
        # Returns:
        ...
        self.src_word_emb = torch.nn.Embedding(emb_mat.size(0), emb_mat.size(1), padding_idx=0)
        self.src_word_emb.weight = torch.nn.Parameter(emb_mat)
